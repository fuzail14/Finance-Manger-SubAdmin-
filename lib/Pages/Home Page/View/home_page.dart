...
enum HomePageType { bills, generatebill, individualbill, logout }
...
homePageNavigation({required String? heading, required User user}) {
  ...
  } else if (HomePageType.individualbill.name == heading.toLowerCase()) {
    Get.offNamed(societyResidentsView, arguments: user);
